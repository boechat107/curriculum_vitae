...
could match the requirements for the software developer position.
\vspace{.2cm}

Although I don't have been working with large-scale web applications, my experiences
with web spiders and image processing as a service gave me the possibility to work
with related technologies. Moreover, as self-study is one of my habits, I believe
I could quickly compensate any lack of experience on some subject. Part of my studies
can be found on my github account (link at the last section of this document).
\vspace{.2cm}
