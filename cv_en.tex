...
\begin{itemize}
    \item Versatile computer engineer interested in solving interesting problems. In
        the last five years, I have worked with signal processing, machine learning,
        image processing, OCR, web spiders and data analysis.
    \item Has experience with multiple technologies and paradigms, like
        object-oriented and functional programming, multiple programming languages
        (C, Java, Python, Clojure, Common Lip, Haskell, Matlab) and decentralized
        architectures (using Redis as MPI). 
    \item Values collaborative working environments, good quality solutions 
        (theory and implementation), self-teaching and self-motivation, good humor
        and friendship.
    \item Open-minded and responsible, understands the importance of criticisms 
        for self-improvement.
    \item Loves MOOCs (massive open online courses).
\end{itemize}
